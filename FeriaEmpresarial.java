    ...
    public String metodo2() {
        ...
        for (Puesto puesto : puestos) {
            if (puesto.estaOcupado()) {
                ...
                if (puesto.estaOcupado().equals(puesto > 60)){
                    system.out.println("SE HA CUMPLIDO EL PUNTO DE EQUILIBRO");
                    else (puesto.estaOcupado().equals(puesto < 60)){
                        system.out.println("NO SE HA CUMPLIDO EL PUNTO DE EQUILIBRO");
                }
